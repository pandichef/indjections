...
### endblock: django-debug-toolbar ###
"""
    assert final_settings_string == original_settings_string + settings_insertstring
    assert final_urls_string == original_urls_string + urls_insertstring
...
"""
    ...
    with open(urls.__file__, 'r') as fn:
        final_urls_string = fn.read()
    assert final_settings_string == original_settings_string + locked_text
    assert final_urls_string == original_urls_string + locked_text
